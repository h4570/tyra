...
#include "shared/renderer/3d/pipeline/static/core/programs/cull/stapip_cull_td_vu1_program.hpp"

extern unsigned int StaPipVU1Cull_TD_CodeStart
    __attribute__((section(".vudata")));
extern unsigned int StaPipVU1Cull_TD_CodeEnd
    __attribute__((section(".vudata")));
